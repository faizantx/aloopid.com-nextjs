...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: rxtOxq8OaOMN/css
import SearchSvg2Icon from "./icons/PlasmicIcon__SearchSvg2"; // plasmic-import: kwhQa2wQUqBm/icon
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: DuV3Ca4-O52c/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvg2Icon
              className={classNames(projectcss.all, sty.svg__kPfbJ)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__bQw2F)}
              role={"img"}
            />
          ),
